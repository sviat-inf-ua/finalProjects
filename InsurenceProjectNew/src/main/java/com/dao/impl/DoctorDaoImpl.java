...
public class DoctorDaoImpl implements DoctorDao {
	...
	public List<Doctor> getActive() {
		...
		Query<Doctor> theQuery = currentSession.createQuery("from Doctor where active = 1", Doctor.class);
	...
	public List<Doctor> getNotActive() {
		...
		Query<Doctor> theQuery = currentSession.createQuery("from Doctor where active = 0", Doctor.class);
		List<Doctor> doctors = theQuery.getResultList();
		return doctors;
	}
